...
@section('content')
            ...
            <!-- end section -->
            <!-- start section -->
            <section class="one-fourth-screen border-radius-6px lg-border-radius-0px border border-color-transparent" data-parallax-background-ratio="0.5" style="background-image: url(https://via.placeholder.com/1920x1100)"></section>
            <!-- end section -->
            <!-- start section -->
            <section>
                <div class="container">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-12" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                            <img src="https://via.placeholder.com/1190x750" class="w-100 mb-7 border-radius-5px" alt="">
                            <img src="https://via.placeholder.com/1190x750" class="w-100 border-radius-5px" alt="">
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-lg-8">
                            <div class="row mb-30px">
                                <div class="tag-cloud col-md-9 text-center text-md-start sm-mb-15px">
                                    <a href="demo-corporate-blog.html">Architecture</a> 
                                    <a href="demo-corporate-blog.html">Interior</a>
                                    <a href="demo-corporate-blog.html">Landscape</a>
                                    <a href="demo-corporate-blog.html">Residential</a>
                                </div> 
                                ...
                                <div class="col-12 mb-6 sm-mb-10">
                                    <div class="bg-nero-grey d-block d-md-flex w-100 box-shadow-extra-large align-items-center border-radius-4px p-7 sm-p-35px">
                                        <div class="w-140px text-center me-50px sm-mx-auto">
                                            ...
                                            <a href="demo-corporate-blog.html" class="text-dark-gray fw-500 mt-20px d-inline-block lh-20">Colene Landin</a>
                                        ...
                                        <div class="w-75 sm-w-100 text-center text-md-start last-paragraph-no-margin">
                                            ...
                                            <a href="demo-corporate-blog.html" class="btn btn-link btn-large text-dark-gray mt-15px">All author posts</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row justify-content-center mb-1">
                        <div class="col-lg-7 text-center" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <span class="ps-25px pe-25px mb-15px text-uppercase text-base-color fs-14 lh-42px fw-700 border-radius-100px bg-gradient-quartz-light-transparent d-inline-block">You may also like</span>
                            ...
                            <ul class="blog-grid blog-wrapper grid grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-double-extra-large">
                                ...
                                <li class="grid-item">
                                    <div class="card border-0 border-radius-5px box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                        ...
                                        <div class="card-body p-12 lg-p-10">
                                            <a href="demo-corporate-blog-single-clean.html" class="card-title mb-15px fw-700 fs-19 lh-30 text-dark-gray d-inline-block w-90 md-w-100">Build up healthy habits and strong peaceful life</a>
                                            ...
                                            <div class="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-14 text-uppercase">
                                                ...
                                                <div class="like-count">
                                                    <a href="demo-corporate-blog-single-clean.html"><i class="fa-regular fa-heart text-red"></i><span class="text-dark-gray align-middle fw-700">25</span></a>
                                                </div>  
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="grid-item">
                                    <div class="card border-0 border-radius-5px box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                        ...
                                        <div class="card-body p-12 lg-p-10">
                                            <a href="demo-corporate-blog-single-clean.html" class="card-title mb-15px fw-700 fs-19 lh-30 text-dark-gray d-inline-block w-90 md-w-100">How to bring the season into your great marketing</a>
                                            <p>Lorem ipsum dolor consectetur adipiscing eiusmod tempor</p>
                                            <div class="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-14 text-uppercase">
                                                <div class="me-auto">
                                                ...
                                                <div class="like-count">
                                                    <a href="demo-corporate-blog-single-clean.html"><i class="fa-regular fa-heart text-red"></i><span class="text-dark-gray align-middle fw-700">58</span></a>
                                                </div>  
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="grid-item">
                                    <div class="card border-0 border-radius-5px box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                        ...
                                        <div class="card-body p-12 lg-p-10">
                                            <a href="demo-corporate-blog-single-clean.html" class="card-title mb-15px fw-700 fs-19 lh-30 text-dark-gray d-inline-block w-90 md-w-100">Be the strong willed one the public relationship</a>
                                            <p>Lorem ipsum dolor consectetur adipiscing eiusmod tempor</p>
                                            <div class="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-14 text-uppercase">
                                                <div class="me-auto">
                                                ...
                                                <div class="like-count">
                                                    <a href="demo-corporate-blog-single-clean.html"><i class="fa-regular fa-heart text-red"></i><span class="text-dark-gray align-middle fw-700">75</span></a>
                                                </div>  
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="container">
                    <div class="row justify-content-center mb-3" data-anime='{ "el": "childs", "translateY": [0, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <div class="col-lg-9 text-center"> 
                            <h6 class="alt-font text-dark-gray fw-700"> Commentaires</h6>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                    <div class="col-lg-9">
                                    ...
                                    <div class="d-block d-md-flex w-100 align-items-center align-items-md-start ">
                                        ...
                                        <div class="w-100 ps-30px last-paragraph-no-margin sm-ps-0">
                                            <a href="#" class="text-dark-gray fw-600">{{ $commentaire->name }}</a>
                                            <a href="#commentaires" class="btn-reply text-uppercase section-link">Reply</a>
                                            <div class="fs-14 lh-24 mb-10px">{{ $commentaire->created_at->format('d M Y, h:i A') }}</div>
                                            <p class="w-85 sm-w-100">{{ $commentaire->content }}.</p>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                ...
                <div class="container" >
                    <div class="row justify-content-center">
                        <div class="col-lg-9 mb-3 sm-mb-6">
                            <h6 class="alt-font text-dark-gray fw-700 mb-5px">Ecrivez un commentaire</h6>
                            <div class="mb-5px">Votre adresse électronique ne sera pas publiée. Les champs obligatoires sont marqués *</div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-lg-9">
                            ...
                            <form action="{{ route('commentaire.store') }}" method="post" class="row ">
                            @csrf
                                ...
                                <div class="col-md-12 mb-30px">
                                    <textarea class="border-radius-4px border-color-charcoal-grey bg-transparent form-control" cols="40" rows="4" name="content" placeholder="Your message"></textarea>
                                    @error('content')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                 </div> 
                                <div class="col-12">
                                    ...
                                    <button type="submit" class="btn btn-dark-gray btn-small btn-round-edge " >Postez votre commentaire</button>
                                </div>
