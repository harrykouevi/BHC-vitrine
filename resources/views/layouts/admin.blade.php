				...
				<div class="main-sidemenu">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<!-- Lien vers la gestion des blogs (affichage de tous les blogs) -->
								<li><a class="slide-item" href="{{ route('admin.blogs.index') }}">Gérer les blogs</a></li>
						
								<!-- Lien vers la page de création d'un nouveau blog -->
								<li><a class="slide-item" href="{{ route('admin.blogs.create') }}">Nouveau blog</a></li>
							</ul>
						</li>
