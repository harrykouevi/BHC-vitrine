...
<html class="no-js" lang="fr">
    <head>
        <title>Crafto - Téléchargement d'Images</title>
        <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row extra-very-small-screen align-items-center">
                    <div class="col-lg-5 col-sm-8 position-relative page-title-extra-small" data-anime='{ "el": "childs", "opacity": [0, 1], "translateX": [-30, 0], "duration": 800, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <h2 class="text-white text-shadow-medium fw-500 ls-minus-2px mb-0">Statement preparation</h2>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 order-1 order-lg-2 md-mb-50px" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <h4 class="text-dark-gray fw-700 ls-minus-1px alt-font mb-20px d-block">Téléchargez votre image</h4>

                        <div class="row align-items-start mb-30px md-mb-15px">
                            <div class="col-lg-12 pe-50px md-pe-15px md-mb-50px xs-mb-35px">
                                <span class="fs-26 alt-font fw-600 text-dark-gray mb-20px d-block">Détails de l'image à charger</span>
                                ...
                                @endif
                                <form class="" action="{{ route('X1-up') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">

                                        <div class="col-12 mb-20px">
                                            <label class="mb-10px">Image</label>
                                            <input class="border-radius-4px input-small" type="file" name="image" required>

                                        </div>

                                        <!-- end tab content -->
                                        <div class="col-12 mb-20px">
                                            <label class="mb-10px">Nom du fichier (optionel)</label>
                                            <input class="border-radius-4px input-small" type="text" name="file_name" aria-label="text">
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-base-color btn-extra-large btn-switch-text btn-round-edge btn-box-shadow w-100 text-transform-none mt-30px">
                                                <span>
                                                    <span class="btn-double-text" data-text="Place order">Télécharger</span>
                                                </span>
                                            </button>
